    ...
    <script>
        $(function () {
          if (location.pathname === "/" || location.pathname === "") {
            window.location.replace(`${location.origin}/Default${location.search}`);
          }
          if(!document.referrer && location.search.length > 0) {
            $.ajax({
