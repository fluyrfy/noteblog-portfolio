...
public class UserRepository
{
  ...
  public List<dynamic> getSkills(int userId)
  {
    string sql = "SELECT * FROM user_skills WHERE user_id = @userId";
    return _dbConnection.Query<dynamic>(sql, new { userId }).ToList();
  }
  ...
  public void update(string name, byte[] avatar, byte[] resume, int id, string phone = "", string region = "", string regionLink = "", string githubLink = "", string jobTitle = "", string about = "")
  {
    string query;
  ...
  public void updateSkill(int id, string skillOneName = "", string skillOnePercent = "", string skillTwoName = "", string skillTwoPercent = "", string skillThreeName = "", string skillThreePercent = "")
  {
